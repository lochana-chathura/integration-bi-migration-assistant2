...
public interface DataWeaveVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code payloadExpression}
	 * labeled alternative in {@link DataWeaveParser#primaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPayloadExpression(DataWeaveParser.PayloadExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArrayType(DataWeaveParser.ArrayTypeContext ctx);
	/**
