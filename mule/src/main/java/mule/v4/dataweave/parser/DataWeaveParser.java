...
public class DataWeaveParser extends Parser {
	...
	public static final int
		...
		NAMESPACE=17, OUTPUT=18, DW=19, TYPE=20, ASSIGN=21, ARROW=22, BOOLEAN=23, 
		WHEN=24, OTHERWISE=25, UNLESS=26, AND=27, OR=28, NOT=29, IF=30, ELSE=31, 
		MAP=32, FILTER=33, GROUP_BY=34, SIZE_OF=35, UPPER=36, LOWER=37, REPLACE=38, 
		WITH=39, FROM=40, AS=41, IS=42, NOW=43, PAYLOAD=44, OPERATOR_EQUALITY=45, 
		OPERATOR_RELATIONAL=46, OPERATOR_MULTIPLICATIVE=47, OPERATOR_ADDITIVE=48, 
		OPERATOR_RANGE=49, CONCAT=50, IDENTIFIER=51, INDEX_IDENTIFIER=52, VALUE_IDENTIFIER=53, 
		URL=54, MEDIA_TYPE=55, NUMBER=56, STRING=57, DATE=58, REGEX=59, DOT=60, 
		COLON=61, COMMA=62, LCURLY=63, RCURLY=64, LSQUARE=65, RSQUARE=66, LPAREN=67, 
		RPAREN=68, SEPARATOR=69, WS=70, NEWLINE=71, COMMENT=72, STAR=73, AT=74, 
		QUESTION=75;
	public static final int
		RULE_script = 0, RULE_header = 1, RULE_directive = 2, RULE_dwVersion = 3, 
		RULE_outputDirective = 4, RULE_importDirective = 5, RULE_namespaceDirective = 6, 
		RULE_variableDeclaration = 7, RULE_functionDeclaration = 8, RULE_typeDeclaration = 9, 
		RULE_body = 10, RULE_expression = 11, RULE_conditionalExpression = 12, 
		RULE_operationExpression = 13, RULE_implicitLambdaExpression = 14, RULE_inlineLambda = 15, 
		RULE_functionParameters = 16, RULE_logicalOrExpression = 17, RULE_logicalAndExpression = 18, 
		...
		RULE_builtInFunction = 27, RULE_grouped = 28, RULE_selectorExpression = 29, 
		RULE_literal = 30, RULE_array = 31, RULE_object = 32, RULE_objectField = 33, 
		RULE_functionCall = 34, RULE_typeExpression = 35;
	private static String[] makeRuleNames() {
		return new String[] {
			"script", "header", "directive", "dwVersion", "outputDirective", "importDirective", 
			"namespaceDirective", "variableDeclaration", "functionDeclaration", "typeDeclaration", 
			"body", "expression", "conditionalExpression", "operationExpression", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'-'", "'String'", "'Number'", "'Boolean'", "'DateTime'", "'LocalDateTime'", 
			"'Date'", "'Time'", "'Array'", "'<'", "'>'", "'Object'", "'Any'", "'var'", 
			"'fun'", "'import'", "'ns'", "'output'", "'%dw'", "'type'", "'='", "'->'", 
			null, "'when'", "'otherwise'", "'unless'", "'and'", "'or'", "'not'", 
			"'if'", "'else'", "'map'", "'filter'", "'groupBy'", "'sizeOf'", "'upper'", 
			"'lower'", "'replace'", "'with'", "'from'", "'as'", "'is'", "'now'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, "VAR", "FUNCTION", "IMPORT", "NAMESPACE", "OUTPUT", "DW", 
			"TYPE", "ASSIGN", "ARROW", "BOOLEAN", "WHEN", "OTHERWISE", "UNLESS", 
			"AND", "OR", "NOT", "IF", "ELSE", "MAP", "FILTER", "GROUP_BY", "SIZE_OF", 
			"UPPER", "LOWER", "REPLACE", "WITH", "FROM", "AS", "IS", "NOW", "PAYLOAD", 
	...
	public final ScriptContext script() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -8126718898247565310L) != 0) || _la==LSQUARE || _la==LPAREN) {
				{
				setState(76);
				body();
				}
	...
	public final ImportDirectiveContext importDirective() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_importDirective);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class WhenConditionContext extends ConditionalExpressionContext {
		...
		public List<TerminalNode> WHEN() { return getTokens(DataWeaveParser.WHEN); }
		public TerminalNode WHEN(int i) {
			return getToken(DataWeaveParser.WHEN, i);
		}
		public List<TerminalNode> OTHERWISE() { return getTokens(DataWeaveParser.OTHERWISE); }
		public TerminalNode OTHERWISE(int i) {
			return getToken(DataWeaveParser.OTHERWISE, i);
		}
		public WhenConditionContext(ConditionalExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitWhenCondition(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class ConditionalExpressionWrapperContext extends ConditionalExpressionContext {
		public OperationExpressionContext operationExpression() {
			return getRuleContext(OperationExpressionContext.class,0);
		}
		public ConditionalExpressionWrapperContext(ConditionalExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).enterConditionalExpressionWrapper(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).exitConditionalExpressionWrapper(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitConditionalExpressionWrapper(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class UnlessConditionContext extends ConditionalExpressionContext {
		...
		public TerminalNode UNLESS() { return getToken(DataWeaveParser.UNLESS, 0); }
		public List<ConditionalExpressionContext> conditionalExpression() {
			return getRuleContexts(ConditionalExpressionContext.class);
		}
		public ConditionalExpressionContext conditionalExpression(int i) {
		...
		public TerminalNode OTHERWISE() { return getToken(DataWeaveParser.OTHERWISE, 0); }
		public UnlessConditionContext(ConditionalExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitUnlessCondition(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class PayloadExpressionContext extends PrimaryExpressionContext {
		public TerminalNode PAYLOAD() { return getToken(DataWeaveParser.PAYLOAD, 0); }
		public PayloadExpressionContext(PrimaryExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).enterPayloadExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).exitPayloadExpression(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitPayloadExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private PrimaryExpressionContext primaryExpression(int _p) throws RecognitionException {
		...
		try {
			...
			case 11:
				{
				_localctx = new PayloadExpressionContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(321);
				match(PAYLOAD);
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(356);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1080863910577307648L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class ArrayTypeContext extends TypeExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).enterArrayType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).exitArrayType(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitArrayType(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
